class GameSettings private constructor() {
    ...
    companion object {
        private val instance: GameSettings = GameSettings()
...
fun main() {
    ...
    settings.setVoiceVolume(0.9)
    settings.setDifficulty("hard")
    settings.setGraphics("high")
    ...
    settings.setDifficulty("ultra")
    settings.setMusicVolume(1.5)

    val settings2 = GameSettings.getInstance()
